...
This tool allows you to automate removing tiktok's annoying outro at the end, specify your directories where video files are, script will detect & remove them.
